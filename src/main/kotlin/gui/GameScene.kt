...
class GameScene(
    ...
    private val shopHabitats = GridPane<HexagonView>(
        ...
        columns = 4,
        spacing = 50,
        visual = ColorVisual(Color(0x5C3A2E))
    )
    ...
    private val ruleSetOverlay = Pane<UIComponent>(
        ...
        width = 1500,
        height = 800,
        visual = ColorVisual(Color(0x704C3C))
    ).apply {
        isVisible = false
    }
    ...
    private val currentPlayerLabel = Label(
        ...
        posY = 20,
        text = "Current Player",
        font = Font(24, Color(0xF5DEB3), "JetBrains Mono ExtraBold"),
        visual = ColorVisual(Color(0x5C3A2E))
    )
    ...
    private val natureTokenLabel = Label(
        ...
        posY = 80,
        text = "NatureToken : 3",
        font = Font(18, Color(0xF5F0E6), "JetBrains Mono ExtraBold"),
        visual = ColorVisual(Color(0x2B5D34))
    )
    ...
    private val replaceWildlifeButton = Button(
        ...
        font = Font(18, Color(0xF5DEB3), "JetBrains Mono ExtraBold"),
        visual = ColorVisual(Color(0x5C3A2E))
    ).apply {
        onMouseExited = {
            visual = ColorVisual(Color(0x5C3A2E))
        ...
        onMouseEntered = {
            visual = ColorVisual(Color(0x8B5A42))
        }
        onMouseClicked = {
    ...
    private fun createPossibleHexagons(position: List<Pair<Int, Int>>) {
        ...
        for (i in position) {
            val hex = HexagonView(
                size = 75,
                visual = ImageVisual("tileOutline.png")
            )
    ...
    private fun processNextRefresh() {
        ...
        if (refreshQueue.isNotEmpty()) {
            ...
            val nextAction = refreshQueue.poll()
