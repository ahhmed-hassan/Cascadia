...
class StartNewGameTest {
    ...
    fun testStartTilesPlacement() {
        ...
        game.playerList.forEachIndexed { index, player ->
            ...
            assertEquals(player.habitat[1 to -1], playerStartTiles[2]) //The lower-right tile should match...
            assertEquals(player.habitat[1 to 0], playerStartTiles[1]) //The lower-left tile should match...
        }
